...
public class Topic_05_HTMLDropdown_list {
	WebDriver driver;
//Random Number
...
//Prepare data test for creating new customer
	  ...
	  pin = "600000"; 
	  phone = "0969506952"; 
	  email = "hanhhong" + randomNumber() + "@gmail.com" ;
	  password = "12345678";
//Prepare data test for editing customer
	  editAddress = "100 Nguyen Hong Hanh"; 
	  editCity = "Ha Noi"; 
	  editState = "Thanh Xuan"; 
	  editPin = "600000"; 
	  editPhone = "0969506952"; 
	  editEmail = "hanhhong" + randomNumber() + "@gmail.com" ;
  }	
  @Test
